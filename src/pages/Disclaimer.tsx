                    ...
                    <div className="px-6 py-8 sm:px-10 space-y-8">
                        ...
                        <section>
                            <h2 className="text-2xl font-semibold text-gray-900 mb-4 flex items-center">
                                <span className="bg-accent w-1 h-8 mr-3 rounded-full"></span>
                                Disclaimer
                            </h2>
                            <div className="prose prose-gray max-w-none text-gray-600 leading-relaxed">
                                <p>
                                    DLF : This website is meant only for information purposes. It should not be considered/ claimed as an official site. This website belongs to the authorised channel partner of DLF. Agent RERA No.: RC/REA/HARERA/GGM/1306/901/2020
                                </p>
                            </div>
                        </section>
                            ...
                            <div className="prose prose-gray max-w-none text-gray-600 space-y-6 leading-relaxed">
                                ...
                                <div>
                                    ...
                                    <ul className="list-disc pl-5 space-y-2">
                                        ...
                                        <li>
                                            <strong>C)</strong> We may disclose your personal information to third parties:
                                            <ul className="list-[circle] pl-5 mt-1 space-y-1">
                                        ...
                                        <li>
                                            <strong>D)</strong> We may share your non sales related information such as Cookies, Email IDs, Phone number etc to external parties. But, we do not share your sales related information such as PAN Card No, Credit / Debit Card details, Preference details with the external parties.
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    <ul className="list-disc pl-5 space-y-2">
                                        <li>
                                            <strong>A)</strong> You have the right to ask us not to process your personal data for marketing purposes.
                                        </li>
                                        <li>
                                            <strong>B)</strong> Our sites may contain links to and from the websites of our partner networks, advertisers and affiliates. If you follow a link, please note that these websites have their own privacy policies and that we do not accept any responsibility or liability for these policies. Please check these policies before you submit any personal data to these websites.
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    <h3 className="text-lg font-medium text-gray-900 mb-2">WHERE WE STORE YOUR PERSONAL DATA</h3>
                                    <ul className="list-disc pl-5 space-y-2">
                                        <li>
